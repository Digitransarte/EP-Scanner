...
def main():
    ...
    # ── EP Pullback Monitor ──────────────────────────────────────────────────
    # DESACTIVADO temporariamente para diagnosticar fonte das mensagens "Posicoes Abertas"
    # no Telegram. Reactivar assim que confirmarmos.
    print("\n[Monitor] Desactivado temporariamente (diagnostico).")
    if False:
        try:
